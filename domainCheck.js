(function () {
    var validDomain = 'www.xscnas.top'; // 你的域名
    var redirectUrl = 'https://www.xscnas.top'; // 重定向链接
    ...
    if (hostname !== validDomain) {
        ...
        var userResponse = confirm("提示：您当前浏览的页面不是正版(或者站点已经迁移域名)，建议您跳转至官方(www.xscnas.top)进行浏览！如果不是博主的域名及时留言反馈，博主域名为：www.xscnas.top");
        if (userResponse) {
