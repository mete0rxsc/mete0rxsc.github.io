...
if (avatar === null || avatar === 'null') {
    ...
    avatarUrl = this.assignAvatar(name);
        ...
        // 修改后代码
        const avatarHTML = (hideAvatar || !avatarUrl || avatarUrl === 'null')
            ? ''
            : `<img class="chatAvatar no-lightbox" src="${avatarUrl}" onerror="this.onerror=null; this.src='https://via.placeholder.com/100';">`;
